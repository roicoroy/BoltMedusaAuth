...
#Preview {
    ...
    let sampleCart = Cart(
        ...
        discountTaxTotal: 0,
        originalTotal: 2500,
        originalTaxTotal: 200,
        itemTotal: 2000,
        itemSubtotal: 2000,
        itemTaxTotal: 200,
        originalItemTotal: 2000,
        originalItemSubtotal: 2000,
        originalItemTaxTotal: 200,
        shippingTotal: 300,
        shippingSubtotal: 300,
        shippingTaxTotal: 0,
        originalShippingTaxTotal: 0,
        originalShippingSubtotal: 300,
        originalShippingTotal: 300,
        metadata: nil,
        salesChannelId: nil,
        items: nil,
        promotions: nil,
    ...
    PaymentProvidersView(cart: sampleCart)
}